...
! function (e) {
  e.fn.fitVids = function (t) {
    ...
    return r.className = "fit-vids-style", r.innerHTML = "&shy;<style> .fluid-width-video-wrapper { width: 100%; position: relative; padding: 0; } .fluid-width-video-wrapper iframe, .fluid-width-video-wrapper object, .fluid-width-video-wrapper embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; } </style>", a.parentNode.insertBefore(r, a), t && e.extend(i, t), this.each((function () {
...
! function (o) {
  o.cookit = function (t) {
    ...
    })("cookies-consent") || (i = o("<p id='cookit-message'>" + n.messageText + "</p>"), link = o("<a id='cookit-link' href='" + n.linkUrl + "' target='_blank'>" + n.linkText + "</a>"), button = o("<a id='cookit-button' href='#'>" + n.buttonText + "</a>"), o("body").append(e), e.append(c), c.append(i), c.append(link), c.append(button), e.css({
