@php
    ...
    $mychoise = App\Models\WebGallery::where('status', 1)->where('mci', '1')->get();
    ...
    <section id="section-testimonial" class="text-light">
        <div class="col-md-12">
            <div class="widget widget_tags mt-5">
                ...
                <div class="card mb-4" style="border: 1px solid orange; background: rgb(228, 203, 148)">
                    <div class="card-body text-center">
                        <h1>My Best choices </h1>
                    </div>
                </div>

                <div class="row">
                    <div id="testimonial-carousel-4-cols" class="owl-carousel owl-theme wow fadeInUp">
                        @forelse ($mychoise as $related)
